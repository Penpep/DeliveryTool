...
def generate_deliveries(qty, pack_size, cadence, shft_hrs, cons_rate, on_hand, max_lineside_qty):
    if not cadence:
        return []
    ...
    consumed = 0
    safety_buffer = max_lineside_qty
    ...
    for _ in range(cadence):
        ...
        if available_on_hand >= (interval_demand + safety_buffer):
        ...
        shortfall = interval_demand - available_on_hand + safety_buffer
